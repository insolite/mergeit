...
class NextVersionFilterTest(RunnerTest):
    ...
    def test_run(self):
        ...
        self.push_handler_mock.repo_manager.get_branches.return_value = branches
        ...
        self.push_handler_mock.repo_manager.get_branches.assert_called_once_with(remote=True)
